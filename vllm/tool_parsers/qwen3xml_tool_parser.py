        ...
        if found_elements:
            ...
            try:
                ...
                if (
                    ...
                    and self.function_end_token in current_input
                ):
                ...
                if (
                    self.current_call_id is not None
                    and self.tool_call_end_token in current_input
                ):
            ...
            if self.current_call_id is not None and (
                self.function_end_token in current_input
                or self.tool_call_end_token in current_input
            ):
                # Close potentially unclosed element
                if self.current_param_name:
                    self._end_element("parameter")
                if self.function_end_token in current_input and self.current_function_name:
                    self._end_element("function")
                if self.tool_call_end_token in current_input:
                    self._end_element("tool_call")
