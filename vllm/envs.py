...
if TYPE_CHECKING:
    ...
    # Retain the final aligned Mamba state under MTP (mamba_cache_mode=align):
    # the uncached prompt tail still runs and produces the proposer's hidden
    # states, so that boundary state is valid and reusable. Default off.
